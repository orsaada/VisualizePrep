...
def chars_in_scenes2(scenes, beforeData):  # maybe need to fix
    res = []
    for (s, e) in scenes:
        characters = []
...
def char_recall(test_id, all_mg, num, data):
...
def get_diff(test_id, all_mg, num, data):
    scenes = moviegraphs.load_scenes(test_id, all_mg)
    if num == 1:
        chars = videoindexer.get_character_app_dict(test_id)
        chars_vi = chars_in_scenes(scenes, chars)
...
def print_pretty_differences_test(tt_movie):
    print("[ start , end ,[Movie Indexer Actors] , [Manual Info Actors] , percentage ]:")
    data_b = get_diff(tt_movie, all_mg, 1, "")
    for obj in data_b:
        print(obj)


def print_pretty_differences(tt_movie, json_movie_name):
    res1 = algorithm_1("C:\\Users\\orel kakon\\Desktop\\תואר תכנה\\visualizeBGU2021\\" + json_movie_name + ".json")
    print("[ start , end ,[Movie Indexer Actors] , [Manual Info Actors] , percentage ]:")
    print("Before algo:")
    data_b = get_diff(tt_movie, all_mg, 1, "")
    for obj in data_b:
        print(obj)
    print("After algo:")
    data_a = get_diff(tt_movie, all_mg, 2, res1)
    for obj in data_a:
        print(obj)
...
def print_pretty_changes_algorithm_1():
    ...
    print("crazy stupid love:\nprecision before - " + str(char_precision('tt1570728', all_mg, 1, "")))
    print('precision after - ' + str(char_precision('tt1570728', all_mg, 2, res1)))
    print('recall before - ' + str(char_recall('tt1570728', all_mg, 1, "")))
    print('recall after - ' + str(char_recall('tt1570728', all_mg, 2, res1)) + '\n')

    print("flight:\nprecision before - " + str(char_precision('tt1907668', all_mg, 1, "")))
    print('precision after - ' + str(char_precision('tt1907668', all_mg, 2, res2)))
    print('recall before - ' + str(char_recall('tt1907668', all_mg, 1, "")))
    print('recall after - ' + str(char_recall('tt1907668', all_mg, 2, res2)) + '\n')

    print("forest gump:\nprecision before - " + str(char_precision('tt0109830', all_mg, 1, "")))
    print('precision after - ' + str(char_precision('tt0109830', all_mg, 2, res3)))
    print('recall before - ' + str(char_recall('tt0109830', all_mg, 1, "")))
    print('recall after - ' + str(char_recall('tt0109830', all_mg, 2, res3)) + '\n')

    print("27 dress:\nprecision before - " + str(char_precision('tt0988595', all_mg, 1, "")))
    print('precision after - ' + str(char_precision('tt0988595', all_mg, 2, res4)))
    print('recall before - ' + str(char_recall('tt0988595', all_mg, 1, "")))
    print('recall after - ' + str(char_recall('tt0988595', all_mg, 2, res4)))


print_pretty_changes_algorithm_1()
#  print_pretty_differences('tt0988595', "27_dress_scaled")
